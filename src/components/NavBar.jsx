...
export default function NavBar() {
  ...
  const activeCategories = data.toolCategories || [];
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="text-xl font-black tracking-tight flex items-center gap-2 text-slate-800 shrink-0 hover:text-emerald-600 transition-colors">
              <span className="text-2xl">🧮</span> LifeHub 계산기
            </Link>
            ...
            <form onSubmit={handleSearch} className="relative max-w-xs w-full ml-4 hidden sm:block">
              <input 
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-100 border-none rounded-full text-sm font-medium focus:bg-white focus:ring-2 focus:ring-emerald-100 transition-all outline-none"
              />
