...
{
  "title": "클릭을 유도하는 매력적인 15자 내외 제목",
  "summary": "1~2문장의 핵심 요약 (구글 스니펫용)",
  "categoryId": "clean, laundry, cook, organize, maintenance, hygiene, efficiency, troubleshoot, lifehack 중 가장 적합한 1개 영문 ID 입력",
  "subcategory": "위에서 선택한 카테고리에 속한 정확한 한글 서브카테고리 이름 1개 입력",
  "problem": "이 문제가 발생하는 일반적인 상황 (공감 유발)",
  "cause": "이 문제가 생기는 과학적/물리적 원인",
  "solution": [
    "1단계: 설명",
    "2단계: 설명",
    "3단계: 설명"
  ],
  "tips": "추가로 알면 좋은 꿀팁이나 주의사항",
  "conclusion": "전체 과정을 요약하는 1문장 마무리",
  "recommendation": {
